...
{
    //Benoit: Part 2 -  Create the Data Models(7)
    ...
    public static class DbInitializer
    {
        public static void Initialize(SchoolContext context)
        {
            ...
            {
                new Instructor{FirstName = "Benoit", LastName = "Poirier", Email = "BenoitPoirier9@outlook.com",HireDate = DateTime.Parse("1997-09-01")},
                new Instructor{FirstName = "John", LastName = "Smith", Email = "JohnSmith@outlook.com",HireDate = DateTime.Parse("1988-09-01")}
            };
